...
public class aggiungiStrumentoWnd extends JFrame{
	...
	public aggiungiStrumentoWnd(JFrame caller) {
		...
		getContentPane().add(btnAggiungiStrumento, "cell 1 1,alignx center,aligny center");
		...
		getContentPane().add(btnRimuoviStrumento, "cell 1 2,alignx center,aligny center");
